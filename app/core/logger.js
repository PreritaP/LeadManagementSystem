...
const logger = new (winston.createLogger)({
    ...
    transports: [
        ...
        new (winston.transports.File)({
            ...
            label          : config.get('logging:label'),
            name           : 'log_file',
            filename       : constant.path.log + 'lms-' + nodeEnv + '-' + moment().format('YYYY_MM_DD') + '.log',
            handleException: true,
            json           : false,
            maxSize        : 52428800,
            maxFiles       : 10,
...
const databaseLogger = new (winston.createLogger)({
    emitErrs  : false,
    transports: [
        new (winston.transports.File)({
            level          : config.get('logging:fileLevel'),
            label          : config.get('logging:label'),
            name           : 'error_file',
            filename       : constant.path.log + 'lms-' + nodeEnv + '-' + moment().format('YYYY_MM_DD') + '.database.error.log',
            handleException: true,
            json           : false,
            maxSize        : 52428800,
            maxFiles       : 10,
